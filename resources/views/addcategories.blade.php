    ...
    <div class="edit-menu row py-2 gx-0">
        ...
        <form action="{{url('savecategory')}}" method="POST">
            ...
            <div class="options col ms-5">
                ...
                <a href="{{url('categories')}}"><button type="button" class="btn btn-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
    ...
    <div class="row gx-0">
        <div class="add-list col-12">
            ...
            <table class="product-table add-table mt-2">
                <tr>
                    <th class="product-table">Categorey name</th>
                    <th class="product-table"><input type="text" name="categoryname" class="product-add-input" placeholder="Enter the category's name"></th>
                </tr>
            </table>
        </form>
        </div>
